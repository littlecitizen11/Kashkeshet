...
namespace ClientCheck
{
    public class Client
    {
        ...
        public void SendPrivateMessage()
        {
            ...
            IChat chat = IsChatExist(listofprivates);
            if (chat == null)
            {
                ...
                chat = IsChatExist(listofprivates);
        ...
        public IChat IsChatExist(List<string> name)
        {
            foreach (var item in _chats)
            {
                ...
                if (item.Destination.Get().SequenceEqual(name))
                    return item;
            }
            return null;
        }
